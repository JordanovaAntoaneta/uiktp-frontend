...
//za da go povlecham quiz od  quizesstudentpage
...
const QuizStudentDetailsPage: React.FC = () => {
  ...
  const { quizId, title } = location.state || {};
  ...
  const getQuizzes = async (userId: number) => {
    try {
      ...
      const response = await fetch(
        `${linkBase}/Quiz/visable-to-me?userid=${userId}`,
  ...
  //sega da go zemam quiz shto e praten od localhost:3000/quizes-student
  useEffect(() => {
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Click 'Start Quiz' to begin. Answer all questions to the best of
