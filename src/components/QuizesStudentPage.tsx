import { Box, Button, ButtonGroup, IconButton, Paper, Stack, Typography } from "@mui/material";
...
const QuizesStudentPage: React.FC = () => {
    ...
    return (
        <div style={{ minHeight: '100vh', height: 'fit-content' }}>
            ...
            <Typography sx={{ ...cloudTextStyle, color: "#3A377B", fontSize: '3rem', fontWeight: 600, marginBottom: '30px' }}>
                My Quizzes
            </Typography>
